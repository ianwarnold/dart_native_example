...
void wrappedRandomArray(Dart_Port dest_port_id,
  ...
  // TODO we don't have access to a reply port out in this scope where we
  // haven't validated the parameters, since the reply port is now one of the
  // parameters...
  // TODO Dart_PostCObject(reply_port_id, &result);
}
